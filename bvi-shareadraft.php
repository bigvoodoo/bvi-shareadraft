<?php
/*
Plugin Name: BVI Share a Draft
Plugin URI: https://github.com/bigvoodoo/bvi-shareadraft
Description: Share private preview links to your drafts
Author: Big Voodoo Interactive
Version: 2.0.0
Author URI: https://www.bigvoodoo.com
Text Domain: bvi-shareadraft
Domain Path: /languages
GitHub Plugin URI: https://github.com/bigvoodoo/bvi-shareadraft
*/
...
?>
            <tr>
                ...
                <td><time title="<?php echo $iso_expires; ?>"
                        datetime="<?php echo $iso_expires; ?>"><?php echo $friendly_delta; ?></time></td>
                <td class="actions">
                    ...
                    <form class="shareadraft-extend" id="shareadraft-extend-form-<?php echo $share['key']; ?>" action=""
                        method="post">
...
?>
                    <a class="delete"
                        href="<?php echo esc_url( $nonced_delete_url ); ?>"><?php _e( 'Delete', 'shareadraft' ); ?></a>
                </td>
            </tr>
            <?php
		endforeach;
...
SELECT;
	...
	?>
<style type="text/css">
a.shareadraft-extend,
a.shareadraft-extend-cancel {
    display: none;
}
...
form.shareadraft-extend,
form.shareadraft-extend input,
form.shareadraft-extend select {
    font-size: 11px;
}
